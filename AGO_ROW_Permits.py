...
prjPath = "\\\\GISAPP\\Workspace\\Horizon\\ArcGISPro_Projects\\FeatureServices\\RightOfWay\\ROW_Permits.aprx"

dict = {"ROW Permits": ["ROW Permits","ROW, Right of Way, Third Party, Permits, Point", "Active ROW Third Party Work Permits throughout City of Pearland.",0],
}
n=0
...
for key, value in dict.items():
    ...
    arcpy.mp.CreateWebLayerSDDraft(mp, sddraft, sd_fs_name, 'MY_HOSTED_SERVICES', 'FEATURE_ACCESS','ROW_Permits', True, True, False, True)
