...
prjPath = "\\\\GISAPP\\Workspace\\Horizon\\ArcGISPro_Projects\\FeatureServices\\CodeEnforcement\\HealthInspections.aprx"

dict = {"Health Inspections": ["Health_Inspections","Health Inspections, Code Enforcement, Point", "This layer contains the Health Inspection Reports for the City of Pearland.",0],
}
n=0
